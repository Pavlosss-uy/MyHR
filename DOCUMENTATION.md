<!--
  ...
  Generated by concatenating docs/*.md in order. Edit the per-chapter files in docs/
  and re-run the assembly, rather than editing this file directly.
  Export to PDF/Word with Times New Roman per the faculty template.
-->
